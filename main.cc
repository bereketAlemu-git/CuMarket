...
int testAddListing(){
    ...
    vector<Category> categories = {cars, misc, computers, misc};
    vector<string> categoriesStr = {"cars", "misc", "computers", "misc"};
    vector<Price> prices = {Price(200), Price(0), Price(500), Price(100)};
    vector<string> priceStr = {"$200.00", "$0.00", "$500.00", "$100.00"};
    ...
    Price price(100);
    market.addListing("Eve", "Should not print", misc, "fake description", price);
...
int testPrintByUser(){
    ...
    vector<Category> categories = {cars, misc, computers, misc, misc, misc};
...
int testPrintByCategory(){
    ...
    tester.initCapture();
    market.printListingsByCategory(misc);
    tester.endCapture();
    int points = 0;
    int error = 0;
